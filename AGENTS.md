...
- **V0.57.0** — 当前：create --seed + manga --output<br>　　　　　　`workshop create --seed N` 固定种子，可复现结果<br>　　　　　　`workshop manga --output DIR` 保存拼页+逐格图+metadata.json<br>　　　　　　manga 输出目录包含逐格 panel_*.png 和 metadata.json（剧本/角色/路径）<br>　　　　　　版本 0.57.0<br>
